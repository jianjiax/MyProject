...
public class Dialog extends android.app.Dialog{
	...
	public Dialog(Context context,String title, String acceptStr,String message) {
		super(context, android.R.style.Theme_Translucent);
		this.context = context;// init Context
		this.message = message;
		this.title = title;
		this.buttonAcceptText = acceptStr;
	}
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
		...
		if(TextUtils.isEmpty(buttonAcceptText)){
			this.buttonAccept.setText(context.getString(R.string.confirm));
		}else{
